...
// 翻译协议客户端:OpenAI 兼容大模型 / DeepL / 百度翻译开放平台。
...
public:
    struct Config {
        QString protocol;   // "openai" | "deepl" | "baidu"
        QString baseUrl;    // openai 必填;deepl/baidu 留空用官方地址
        QString apiKey;     // openai key / DeepL auth key / 百度密钥
        QString appId;      // 仅百度
