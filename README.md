...
Language (English / 简体中文, follows the system by default), hotkeys, save directory, history size, autostart and the startup update check are all configurable via tray → Settings.
